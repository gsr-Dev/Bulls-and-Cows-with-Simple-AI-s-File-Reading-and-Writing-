package game;/*
 * CompSci 101 - main.Keyboard Class
 * ============================
 ...
 * Example usage:
 *
 * String input = main.Keyboard.readInput();
 *
...
public class Keyboard {
    ...
    public static String readInput() {
        ...
        try {
            ...
            System.err.println("An error has occurred in the main.Keyboard constructor.");
            e.printStackTrace();
            System.exit(-1);
        }
        ...
        try {
            ...
            System.err.println("An error has occurred in the main.Keyboard.readInput() method.");
            e.printStackTrace();
            System.exit(-1);
        }
        return null;
